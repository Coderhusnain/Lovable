...
const generatePDF = (values: Record<string, string>) => {
  ...
  // ── Title ──
  doc.setFontSize(13);
  boldUnderlinedCentre(doc, "FRANCHISE PURCHASE", y, 13);
  y += lh * 2;
  ...
  doc.setFontSize(11);
  doc.text(
    `Subject: Franchise Purchase – ${values.party1Name || "First Party"} & ${values.party2Name || "Second Party"}`,
    L, y
  );
  y += lh * 1.6;
  ...
  const p1a = "I am writing to formally confirm the Franchise Purchase with ";
  ...
  doc.save("franchise_purchase.pdf");
};
...
export default function FranchisePurchaseForm() {
  return (
    <FormWizard
      ...
      documentType="franchisepurchase"
    />
  );
}