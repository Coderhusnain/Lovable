...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = "GENERAL POWER OF ATTORNEY";
  ...
  addParagraphWithUnderline(
    "",
    agentName,
    " as my true and lawful Attorney-in-Fact to act on my behalf in all lawful matters."
  );

  addParagraph(
    "This General Power of Attorney grants the agent full authority to manage, handle, and conduct my financial, legal, business, and personal affairs, including but not limited to managing bank accounts, buying or selling property, signing contracts, handling transactions, and representing me before institutions or authorities."
  );

  addParagraph(
    "All acts carried out by my Attorney-in-Fact pursuant to this authority shall be binding upon me as if personally performed by me."
  );

  addParagraph(
    "This Power of Attorney shall become effective immediately and shall remain in effect unless revoked by me in writing in accordance with applicable law."
  );

  addParagraph(
    "In witness whereof, I have executed this General Power of Attorney on the date written above."
  );
...
export default function GeneralPowerOfAttorneyForm() {
  return (
    <FormWizard
      steps={steps}
      ...
      documentType="generalpowerofattorney"
    />
  );
}
