...
const generatePDF = (values: Record<string, string>) => {
  ...
  doc.text("Marketing Agreement Form Simple", 105, y, { align: "center" });
  y += 15;
  ...
  doc.save("marketing_agreement_form_simple.pdf");
};

export default function MarketingAgreementFormSimple() {
  return (
    <FormWizard
      steps={steps}
      title="Marketing Agreement Form Simple"
      subtitle="Complete each step to generate your document"
      onGenerate={generatePDF}
      documentType="marketingagreementformsimple"
    />
  );
}
