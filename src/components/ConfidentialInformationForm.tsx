...
const generatePDF = (values: Record<string, string>) => {
  ...
  doc.text("Confidential Information", 105, y, { align: "center" });
  y += 15;
  ...
  doc.save("confidential_information.pdf");
};

export default function ConfidentialInformation() {
  return (
    <FormWizard
      steps={steps}
      ...
      documentType="confidentialinformation"
    />
  );
}
