...
const generatePDF = (values: Record<string, string>) => {
  ...
  // ── Title ──
  doc.setFontSize(13);
  boldUnderlinedCentre(doc, "BARTER AGREEMENT", y, 13);
  y += lh * 2;
  ...
  doc.setFontSize(11);
  doc.text(
    `Subject: Barter Agreement – ${values.party1Name || "First Party"} & ${values.party2Name || "Second Party"}`,
    L, y
  );
  y += lh * 1.6;
  ...
  const p1a = "I am writing to formally confirm the Barter Agreement with ";
