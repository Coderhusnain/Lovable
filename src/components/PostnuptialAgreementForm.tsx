...
const generatePDF = (values: Record<string, string>) => {
  ...
  addUnderlinedField("First Spouse:", values.party1Name || "");
  addUnderlinedField("Second Spouse:", values.party2Name || "");
  ...
  addParagraphWithUnderline(
    "This Postnuptial Agreement is entered into between ",
    party1,
    " and "
  );
  ...
  addParagraphWithUnderline(
    "",
    party2,
    ", who are lawfully married to each other."
  );

  addParagraph(
    "The parties wish to define their respective rights and obligations regarding property, income, assets, debts, and financial matters during the marriage and in the event of separation, divorce, or death."
  );

  addParagraph(
    "Each party agrees that property owned individually before or during the marriage may be treated as separate property except as otherwise provided in this Agreement."
  );

  addParagraph(
    "The parties agree on the division and management of marital assets, liabilities, and financial responsibilities as set forth herein."
  );

  addParagraph(
    "Each spouse acknowledges full and fair disclosure of assets and liabilities and enters into this Agreement voluntarily, knowingly, and without coercion."
  );

  addParagraph(
    "This Agreement shall be governed by the laws of the selected jurisdiction and shall remain effective unless amended or revoked in writing by both parties."
  );
