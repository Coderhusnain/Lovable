...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = "Information Provided for Police Report Letter";
...
doc.setFontSize(11);
doc.text(
  "Subject: Information Provided for Police Report",
  margin,
  y
);
y += 10;
...
// Police station name (underlined dynamically)
const policeStation = values.policeStationName || "the concerned police station";

addParagraphWithUnderline(
  "I am writing to formally provide information regarding an incident reported to ",
  policeStation,
  "."
);
...
// Incident details
addParagraph(
  `The incident occurred on ${values.incidentDate || "________"} at ${
    values.incidentLocation || "________"
  }. ${values.incidentDescription || "Details of the incident are provided as reported."}`
);

// Request for action
addParagraph(
  "I respectfully request that this information be recorded and appropriate action be taken as deemed necessary. I am willing to cooperate fully with any investigation and to provide additional information if required."
);

// Contact paragraph
addParagraph(
  "Please contact me should you require any further clarification or documentation regarding this matter."
);
