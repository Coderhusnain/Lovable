...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = " Direct Mail advertising Letter";
...
doc.setFontSize(11);
doc.text(
  "Subject: Direct Mail advertising",
  margin,
  y
);
y += 10;
...
// Value proposition
addParagraph(
  "Our goal is to deliver exceptional service and competitive pricing while ensuring customer satisfaction. We would be delighted to have the opportunity to serve you."
);
...
// Closing
addParagraph(
  "We look forward to the opportunity to work with you and appreciate your time and consideration."
);
  ...
  // ===== SAVE =====
  doc.save("direct_mail_advertising.pdf");
};
