...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = "  Request for Removal of Personal Information Letter";
...
// Compliance request
addParagraph(
  "Please confirm in writing once my personal information has been deleted and is no longer being processed, stored, or shared. If additional information is required to verify my identity or process this request, please notify me promptly."
);

// Legal tone
addParagraph(
  "This request is made in accordance with applicable privacy and data protection laws and is expected to be handled within the timeframe required by such regulations."
);
...
addParagraph(
  ...
  // ===== SAVE =====
  doc.save("remove_personal_info.pdf");
};
