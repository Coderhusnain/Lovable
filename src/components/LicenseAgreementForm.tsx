...
const generatePDF = (values: Record<string, string>) => {
  ...
  doc.setFont("helvetica", "bold");
  doc.setFontSize(10);
  doc.text("Subject: Notice of License Agreement and Terms of Engagement", margin, y);
  y += 7;
  ...
  underlined("Licensor:  ", values.party1Name || "N/A");
  ...
  para(`I am writing to formally confirm the License Agreement entered into as of ${values.effectiveDate || "N/A"}, between ${values.party1Name || "the Licensor"} and ${values.party2Name || "the Licensee"}, governed by the laws of ${jurisdiction || "the applicable jurisdiction"}.`);

  para(`${values.description || "The Licensor hereby grants to the Licensee a license to use the property, intellectual property, software, or other assets described herein, subject to the terms and conditions of this agreement. The Licensee agrees to use the licensed subject matter only as expressly permitted and to comply with all applicable laws and regulations."}`);
