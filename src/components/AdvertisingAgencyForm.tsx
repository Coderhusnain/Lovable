...
const generatePDF = (values: Record<string, string>) => {
  ...
  // ── Title ──
  boldUnderlinedCentre(doc, "ADVERTISING AGENCY", y, 13);
  y += lh * 2;
  ...
  // ── Subject (bold) ──
  doc.setFont("helvetica", "bold");
  doc.text("Subject: Advertising Agency – ", L, y);
  let sx = L + doc.getTextWidth("Subject: Advertising Agency – ");
  ...
  let cx = inlineVal(doc, "I am writing to formally confirm the Advertising Agency with ", p2name, L, y);
  ...
  doc.save("advertising_agency.pdf");
};
...
export default function AdvertisingAgency() {
  return (
    <FormWizard
      ...
      documentType="advertisingagency"
    />
  );
}