...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = "  Complaint and Request for Refund Letter";
...
doc.setFontSize(11);
doc.text(
  "Subject: Complaint and Request for Refund",
  margin,
  y
);
y += 10;
...
addParagraph(
  "I would appreciate a written response confirming the status of this request within a reasonable timeframe."
);

// Closing
addParagraph(
  "Thank you for your prompt attention to this matter. I look forward to your response and a satisfactory resolution."
);
  ...
  // ===== SAVE =====
  doc.save("complaint_for_refund.pdf");
};
