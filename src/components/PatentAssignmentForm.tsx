...
const generatePDF = (values: Record<string, string>) => {
  ...
  doc.setFont("helvetica", "bold");
  doc.setFontSize(10);
  doc.text("Subject: Notice of Patent Assignment", margin, y);
  y += 7;
  ...
  underlined("Assignor (Patent Owner):  ", values.party1Name || "N/A");
  ...
  para(`I am writing to formally confirm the Patent Assignment entered into as of ${values.effectiveDate || "N/A"}, between ${values.party1Name || "the Assignor"} and ${values.party2Name || "the Assignee"}, governed by the laws of ${jurisdiction || "the applicable jurisdiction"}.`);

  para(`${values.description || "The Assignor hereby irrevocably assigns to the Assignee all rights, title, and interest in and to the patent(s) described herein, including all claims, continuations, divisionals, reissues, and foreign counterparts. The Assignor warrants that they are the sole owner of the patent(s) and have full authority to make this assignment."}`);
