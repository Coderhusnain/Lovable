...
const generatePDF = (values: Record<string, string>) => {
  ...
  // ── Title ──
  boldUnderlinedCentre(doc, "MERCHANDISING AGREEMENT", y, 13);
  y += lh * 2;
  ...
  // ── Subject (bold) ──
  doc.setFont("helvetica", "bold");
  doc.text("Subject: Merchandising Agreement – ", L, y);
  let sx = L + doc.getTextWidth("Subject: Merchandising Agreement – ");
  ...
  let cx = inlineVal(doc, "I am writing to formally confirm the Merchandising Agreement with ", p2name, L, y);
