...
information about an applicant from a bank or financial institution.
  `.trim();
...
y += descLines.length * 5 + 10;
  ...
  doc.save("bankcredit_reference.pdf");
};

export default function BankCreditReferenceForm() {
  return (
    <FormWizard
      steps={steps}
      title="Bank credit reference"
      subtitle="Complete each step to generate your document"
      onGenerate={generatePDF}
      documentType="bankcreditreference"
    />
  );
}
