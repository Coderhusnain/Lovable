...
// Request
addParagraph(
  "The product is currently within the applicable warranty period. I respectfully request repair or replacement of the product in accordance with the warranty terms and conditions."
);

// Supporting documents
addParagraph(
  "Proof of purchase and any required documentation can be provided upon request. Please advise on the next steps for service, including shipping instructions or service center details if applicable."
);

// Closing
addParagraph(
  "Thank you for your prompt attention to this matter. I look forward to your response and resolution under the warranty provisions."
);
  ...
  // ===== SAVE =====
  doc.save("waranty_repair_request.pdf");
};
...
export default function WarrantyRepairRequestForm() {
  return (
    <FormWizard
      steps={steps}
      title="Waranty repair request"
      subtitle="Complete each step to generate your document"
      onGenerate={generatePDF}
      documentType="Warantyrepairrequest"
    />
  );
}
