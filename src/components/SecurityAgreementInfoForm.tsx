...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = "  Security Agreement Information Letter";
...
doc.setFontSize(11);
doc.text(
  "Subject: Security Agreement Information",
  margin,
  y
);
y += 10;
...
// Additional rights
addParagraph(
  "In the event of default, the secured party may exercise all rights and remedies available under the security agreement and applicable law."
);

// Closing
addParagraph(
  "This information is provided for record-keeping and reference purposes. Please review the details and contact the undersigned if clarification or additional documentation is required."
);
...
addParagraph(
  ...
  // ===== SAVE =====
  doc.save("security_agreement_info.pdf");
};

export default function SecurityAgreementInfoForm() {
  return (
    <FormWizard
      steps={steps}
      title="Security Agreement Info"
      subtitle="Complete each step to generate your document"
      onGenerate={generatePDF}
      documentType="securityagreementinfo"
    />
  );
}
