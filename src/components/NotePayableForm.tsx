...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = "Note Payable Acknowledgment Letter";
...
doc.setFontSize(11);
doc.text(
  "Subject: Note Payable Acknowledgment",
  margin,
  y
);
y += 10;
...
// Introduction
addParagraph(
  "This letter confirms and documents the existence of a Note Payable issued by the undersigned debtor in favor of the creditor. The debtor acknowledges the obligation to repay the amount described below in accordance with the agreed terms."
);
...
addParagraph(
  "The debtor agrees to repay the principal amount together with any applicable interest in accordance with the terms stated above. Payments shall be made in full on or before the maturity date unless otherwise agreed in writing by both parties."
);

// Default clause
addParagraph(
  "Failure to make payment as agreed may result in the creditor pursuing any rights or remedies available under applicable law or the underlying agreement."
);

// Record statement
addParagraph(
  "This document is provided for record-keeping purposes and serves as written acknowledgment of the financial obligation."
);

// Closing
addParagraph(
  "Signed and acknowledged by the debtor on the date indicated below."
);
