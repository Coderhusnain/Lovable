...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = "  Request for Removal from Marketing and Mailing Letter";
...
doc.setFontSize(11);
doc.text(
  "Subject: Request for Removal from Marketing and Mailing Lists",
  margin,
  y
);
y += 10;
...
// Introduction
addParagraph(
  "I am writing to request that my personal information be removed from your marketing, promotional, and mailing lists. I no longer wish to receive marketing communications from your organization."
);

// Contact details to remove
addParagraph(
  "Please remove the following contact information from all marketing databases and distribution systems:"
);
...
// Compliance request
addParagraph(
  "This request applies to all forms of marketing communication, including email, telephone calls, text messages, and physical mail. Please also ensure that my information is not shared with third parties for marketing purposes."
);

// Confirmation
addParagraph(
  "Kindly confirm in writing once my information has been removed and the request has been fully processed."
);
...
addParagraph(
  ...
  // ===== SAVE =====
  doc.save("remove_from_marketinglist_request.pdf");
};
