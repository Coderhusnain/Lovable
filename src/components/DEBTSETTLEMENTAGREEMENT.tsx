...
// Settlement terms
addParagraph(
  "Upon receipt of the settlement amount by the due date, the Creditor agrees to consider the debt fully satisfied and to release the Debtor from any further obligation related to this account."
);

// Default clause
addParagraph(
  "If the settlement amount is not received by the due date, this agreement may become void, and the Creditor reserves the right to pursue the full original balance, subject to applicable law."
);

// Reporting / records
addParagraph(
  "The Creditor agrees to update its records to reflect that the account has been settled, in accordance with applicable policies and legal requirements."
);

// Modification clause
addParagraph(
  "Any changes to this settlement arrangement must be made in writing and agreed to by both parties."
);

// Closing
addParagraph(
  "This document serves as a formal record of the agreed debt settlement terms. Please retain a copy for your records."
);
