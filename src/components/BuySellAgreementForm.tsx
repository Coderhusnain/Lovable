...
const generatePDF = (values: Record<string, string>) => {
  ...
  doc.setFont("helvetica", "bold");
  doc.setFontSize(10);
  doc.text("Subject: Notice of Buy-Sell Agreement and Terms of Engagement", margin, y);
  y += 7;
  ...
  // BODY
  para(`I am writing to formally confirm the Buy-Sell Agreement entered into as of ${values.effectiveDate || "N/A"}, between ${values.party1Name || "the First Party"} (${values.party1Type === "business" ? "a business entity" : "an individual"}) and ${values.party2Name || "the Second Party"} (${values.party2Type === "business" ? "a business entity" : "an individual"}), governed by the laws of ${jurisdiction || "the applicable jurisdiction"}, effective immediately.`);

  para(values.description || "Both parties agree to the terms governing the purchase and sale of business interests, shares, or assets as described herein. This agreement establishes the conditions under which ownership interests may be transferred, including valuation methods, payment terms, and triggering events.");
