...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = "  Inquiry Regarding Mobile Phone for Information Letter";
...
doc.setFontSize(11);
doc.text(
  "Subject: Inquiry Regarding Mobile Phone Services and Plans",
  margin,
  y
);
y += 10;
...
// Response request
addParagraph(
  "Please provide the requested information at your earliest convenience. If any further details are required from my side to process this request, kindly let me know."
);
...
addParagraph(
  ...
  // ===== SAVE =====
  doc.save("cellphone_inquiry.pdf");
};
