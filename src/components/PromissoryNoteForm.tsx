...
// Obligation clause
addParagraph(
  "The Borrower agrees to repay the full amount of principal and any accrued interest according to the terms stated above."
);

// Default clause
addParagraph(
  "If the Borrower fails to make any required payment when due, the Lender may declare the entire unpaid balance immediately due and payable, subject to applicable law."
);

// Modification clause
addParagraph(
  "Any modification to this Promissory Note must be made in writing and signed by both parties."
);

// Closing
addParagraph(
  "This document serves as a formal and legally binding promise to repay the debt described herein. Both parties should retain a copy for their records."
);
