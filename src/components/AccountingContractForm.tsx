...
export default function SecurityAgreementForm() {
  ...
  const generatePDF = () => {
    ...
    doc.text(`Debtor: ${formData.debtorName}`, 20, y); y += 10;
    doc.text(`Address: ${formData.debtorAddress}`, 20, y); y += 20;
    
    doc.text(`Secured Party: ${formData.securedPartyName}`, 20, y); y += 10;
    doc.text(`Address: ${formData.securedPartyAddress}`, 20, y); y += 20;
