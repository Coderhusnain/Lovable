...
// Default clause
addParagraph(
  "If any payment is missed or delayed, the Creditor may declare the remaining balance immediately due and payable, subject to applicable law or any written modification agreed upon by the parties."
);

// Modification clause
addParagraph(
  "Any changes to this payment arrangement must be made in writing and agreed to by both parties."
);

// Closing
addParagraph(
  "This document serves as a formal record of the agreed payment terms. Please retain a copy for your records."
);
