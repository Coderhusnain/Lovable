...
is commonly used when a beneficiary name has changed or needs correction in the
...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = "Request for Change of Beneficiary Letter";
...
doc.setFontSize(11);
doc.text(
  "Subject: Request for Change of Beneficiary",
  margin,
  y
);
y += 10;
...
addParagraphWithUnderline(
  "I am writing to formally request a change of beneficiary for my policy/account held with ",
  organization,
  "."
);
...
addParagraph(
  "I kindly request written confirmation once this change has been processed. If any additional documentation or information is required to complete this request, please contact me at your earliest convenience."
);
...
addParagraph(
  ...
  // ===== SAVE =====
  doc.save("change_of_beneficiary.pdf");
};
...
export default function ChangeOfBeneficiaryForm() {
  return (
    <FormWizard
      steps={steps}
      title="Change of Beneficiary Form"
