...
const generatePDF = (values: Record<string, string>) => {
  ...
  doc.setFont("helvetica", "bold");
  doc.setFontSize(10);
  doc.text("Subject: Notice of Strategic Alliance Agreement and Terms of Engagement", margin, y);
  y += 7;
  ...
  // ── BODY PARAGRAPHS ──
  para(
    `I am writing to formally confirm the Strategic Alliance Agreement entered into as of ${values.effectiveDate || "N/A"}, between ${values.party1Name || "the First Party"} (${values.party1Type === "business" ? "a business entity" : "an individual"}) and ${values.party2Name || "the Second Party"} (${values.party2Type === "business" ? "a business entity" : "an individual"}), governed by the laws of ${jurisdiction || "the applicable jurisdiction"}, effective immediately.`
  );

  para(
    values.description ||
    "Both parties agree to form a strategic alliance for the purpose of combining their respective strengths, resources, and expertise toward shared business objectives, in accordance with the applicable terms and conditions of this agreement."
  );
