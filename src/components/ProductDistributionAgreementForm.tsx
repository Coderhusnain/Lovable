...
const generatePDF = (values: Record<string, string>) => {
  ...
  doc.text("Product Distribution Agreement", 105, y, { align: "center" });
  y += 15;
...
export default function ProductDistributionAgreement() {
  return (
    <FormWizard
      steps={steps}
      ...
      documentType="productdistributionagreement"
    />
  );
}
