...
const generatePDF = (values: Record<string, string>) => {
  ...
  const title = "  Installment Promissory Note Letter";
...
doc.setFontSize(11);
doc.text(
  "Subject: Installment Promissory Note",
  margin,
  y
);
y += 10;
...
// Default clause
addParagraph(
  "If any installment payment is not made when due, the Lender may declare the entire remaining balance immediately due and payable, subject to applicable law."
);

// Prepayment clause
addParagraph(
  "The Borrower may prepay this note in whole or in part at any time without penalty unless otherwise agreed in writing."
);

// Closing
addParagraph(
  "This document serves as a formal record of the Borrower’s obligation and the agreed repayment terms between the parties."
);
  ...
  // ===== SAVE =====
  doc.save("installment_promissory.pdf");
};
...
export default function InstallmentPromissoryNoteForm() {
  return (
    <FormWizard
      ...
      documentType="installmentpromisssory"
    />
  );
}
