...
const generatePDF = (values: Record<string, string>) => {
  ...
  doc.setFont("helvetica", "bold");
  doc.setFontSize(10);
  doc.text("Subject: Notice of Fee Agreement and Terms of Engagement", margin, y);
  y += 7;
  ...
  doc.setFont("helvetica", "bold");
  doc.setFontSize(10);
  const senderName = values.party1Name || "Service Provider";
  ...
  doc.setFont("helvetica", "bold");
  doc.setFontSize(10);
  doc.text("Service Provider Signature:", margin, y);
  doc.setFont("helvetica", "normal");
  doc.text(values.party1Signature || "________________________", margin + doc.getTextWidth("Service Provider Signature:  "), y);
  y += 7;
  doc.setFont("helvetica", "bold");
