...
const generatePDF = (values: Record<string, string>) => {
  ...
  // ── Title ──
  boldUnderlinedCentre(doc, "MARKETING AGREEMENT", y, 13);
  y += lh * 2;
  ...
  // ── Subject (bold) ──
  doc.setFont("helvetica", "bold");
  doc.text("Subject: Marketing Agreement – ", L, y);
  let sx = L + doc.getTextWidth("Subject: Marketing Agreement – ");
  ...
  let cx = inlineVal(doc, "I am writing to formally confirm the Marketing Agreement with ", p2name, L, y);
