...
const steps: Array<{ label: string; fields: FieldDef[] }> = [
  {
    ...
    fields: [
      { name: "stateCounty", label: "State/County", type: "text", required: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "notaryMonthYear", label: "Notary month/year", type: "text", required: true },
      { name: "proofType", label: "Proof of identity provided", type: "text", required: true },
      { name: "commissionExpires", label: "Notary commission expires", type: "text", required: true },
    ],
  },
];
...
const generatePDF = (v: Record<string, string>) => {
  ...
  uf("State/County of", v.stateCounty);
  p(`I, ${u(v.affiantName)}, being duly sworn, do hereby depose and state as follows:`);
  p(
    `1. That I am over the age of eighteen (18) years and a resident of ${u(v.affiantResidence)}. I am competent to make this Affidavit and have personal knowledge of the facts stated herein. If called upon to testify, I would be able and competent to do so.`
  );
  p(
  ...
  p(
    `Subscribed and sworn to before me on this ${u(v.notaryDay, 3)} day of ${u(v.notaryMonthYear)}, by ${u(v.affiantName)}, who is personally known to me or has produced satisfactory proof of identity: ${u(v.proofType)}.`
  );
  uf("Notary Public", "");
  uf("My Commission Expires", v.commissionExpires);

  y += 2;
  p("Affidavit Checklist", true);
  p("Make It Legal - This Affidavit must be signed in front of a notary public and becomes effective as of the date signed.");
