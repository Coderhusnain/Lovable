        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4">
              What Is a Balloon Payment Promissory Note?
            </h1>
            <p className="text-xl text-gray-600">
              Complete guide to understanding and creating a Balloon Payment Promissory Note
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
              <h3 className="font-semibold text-blue-900 mb-2">
                Typically, a Balloon Payment Promissory Note includes:
              </h3>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              You may consider using a Balloon Payment Promissory Note in the following situations:
            </p>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-6">
              To ensure legal validity, the note must include the following elements:
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="border rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-3 text-bright-orange-600">
                  1. Borrower & Lender Information
                </h3>
              ...
              <div className="border rounded-lg p-6">
                ...
                <p className="text-gray-700">
                  Conditions under which the full balance becomes immediately due, including missed
                  payments, insolvency, or misrepresentation.
                </p>
              </div>

              <div className="border rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-3 text-bright-orange-600">
                  4. Security & Governing Law
                </h3>
                <p className="text-gray-700">
                  Details of any collateral securing the loan and the state law governing the
                  agreement.
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-6">
              With Legalgram, creating a Balloon Payment Promissory Note is quick and
              straightforward:
            </p>
            ...
            <div className="bg-gradient-to-r from-bright-orange-50 to-bright-orange-100 p-6 rounded-lg">
              ...
              <p className="text-gray-700 mt-4 font-medium">
                This method ensures clarity, compliance, and enforceability without legal
                complexity.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-green-500 bg-green-50 p-4">
                ...
                <p className="text-green-800">
                  A balloon payment is a large, final payment due at the end of the loan term that
                  covers the remaining unpaid principal balance.
                </p>
              </div>
              ...
              <div className="border-l-4 border-blue-500 bg-blue-50 p-4">
                ...
                <p className="text-blue-800">
                  Yes. Most balloon payment promissory notes allow prepayment without penalty unless
                  otherwise stated.
                </p>
              </div>
              ...
              <div className="border-l-4 border-purple-500 bg-purple-50 p-4">
                ...
                <p className="text-purple-800">
                  Upon default, the lender may accelerate the debt, making the full outstanding
                  balance immediately due.
                </p>
              </div>
              ...
              <div className="border-l-4 border-orange-500 bg-orange-50 p-4">
                ...
                <p className="text-orange-800">
                  Collateral is optional but commonly included, especially in real estate-backed
                  balloon loans.
                </p>
              </div>
            </div>
          ...
          <section className="text-center bg-gradient-to-r from-bright-orange-500 to-bright-orange-600 text-white p-8 rounded-xl">
            <h2 className="text-3xl font-bold mb-4">
              Create Your Balloon Payment Promissory Note Now
            </h2>
            <p className="text-xl mb-6">
              Generate a clear, enforceable Balloon Payment Promissory Note tailored to your loan
              terms in minutes.
            </p>
            <Button
              size="lg"
