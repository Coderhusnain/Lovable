...
const MasterServiceInfo: React.FC = () => {
  const navigate = useNavigate();
  const doc = getDocumentContent("Master Servant Agreement");
      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center space-y-4">
            <Button
              onClick={() => navigate("/documents/MasterServiceAgreementForm")}
              size="lg"
              className="bg-gradient-to-r from-amber-700 to-orange-700 hover:from-amber-800 hover:to-orange-800 text-white px-8 py-3"
            >
...
export default MasterServiceInfo;