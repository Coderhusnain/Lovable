...
const DJContractInfo: React.FC = () => {
  const navigate = useNavigate();
  const doc = documentContent["DJ Contract"] || documentContent["default"];
    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-fuchsia-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          {/* Important Notice */}
          <div className="bg-red-50 border-l-4 border-red-500 rounded-lg p-6 mb-8 flex gap-4">
            <Lock className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
            <div>
              <h3 className="font-bold text-red-900 mb-2">Legal Disclaimer</h3>
              <p className="text-red-800 text-sm">
                A DJ Contract is an important entertainment agreement that protects both DJs and event organizers. Requirements and best practices vary by jurisdiction, event type, and venue. This template is designed as a general reference. For high-value events, complex technical requirements, or jurisdiction-specific concerns, consult with a qualified attorney to ensure the agreement complies with applicable laws, accurately reflects your DJ services terms, and includes all necessary provisions for your specific situation.
              </p>
            </div>
          </div>
