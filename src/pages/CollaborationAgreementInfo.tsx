...
const CollaborationAgreementInfo = () => {
  const navigate = useNavigate();
  const doc = getDocumentContent("Collaboration Agreement");
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="bg-gradient-to-br from-amber-200 to-orange-200 p-4 rounded-full">
          ...
          {doc.otherNames && doc.otherNames.length > 0 && (
            <div className="flex flex-wrap gap-2 justify-center">
              {doc.otherNames.map((name) => (
                <span
                  key={name}
                  className="inline-block px-3 py-1 bg-white text-amber-700 text-sm font-medium rounded-full border border-amber-200"
                >
                  {name}
                </span>
              ))}
        ...
        <div className="text-center bg-gradient-to-r from-amber-100 to-orange-100 rounded-lg p-8 border border-amber-200">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            Ready to Create Your Collaboration Agreement?
          </h2>
...
export default CollaborationAgreementInfo;
