import { Lock, Users, ShieldAlert, FileText, CheckCircle, AlertCircle } from "lucide-react";
import { Button } from "@/components/ui/button";
import Layout from "@/components/layout/Layout";
import employeeConfidentialityAgreementInfo from "@/data/employeeConfidentialityAgreementInfo";
import { useNavigate } from "react-router-dom";

const EmployeeConfidentialityAgreementInfo: React.FC = () => {
  const navigate = useNavigate();
  const info = employeeConfidentialityAgreementInfo;

  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50">
        {/* Hero Section */}
        <section className="py-10 bg-gradient-to-r from-purple-600 to-indigo-600">
          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
              <div className="flex gap-4 mb-6">
                <ShieldAlert className="h-8 w-8 text-purple-600 flex-shrink-0 mt-1" />
                <div>
                  <h2 className="text-3xl font-bold text-gray-900 mb-4">
                    Why You Need an Employee Confidentiality Agreement
                  </h2>
        ...
        {/* Highlights Section */}
        <section className="py-10 bg-gradient-to-r from-purple-50 to-indigo-50">
          <div className="container-custom">
            <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">
        ...
        <section className="py-10 bg-gradient-to-r from-purple-600 to-indigo-600">
          <div className="container-custom text-center">
            ...
            <p className="text-lg text-white opacity-90 mb-8 max-w-2xl mx-auto">
              Download a professionally drafted Employee Confidentiality Agreement and secure your trade secrets today.
            </p>
...
export default EmployeeConfidentialityAgreementInfo;
