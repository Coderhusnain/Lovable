...
const AttorneyEngagementLetterInfo: React.FC = () => {
  const navigate = useNavigate();
  const doc = documentContent["Attorney Engagement Letter"] || documentContent["default"];
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="bg-amber-50 border-l-4 border-amber-500 rounded-lg p-6 mb-8 flex gap-4">
            ...
            <div>
              <h3 className="font-bold text-amber-900 mb-2">Legal Disclaimer</h3>
              <p className="text-amber-800 text-sm">
                An Attorney Engagement Letter is an important professional document that governs legal representation. Requirements and best practices vary by jurisdiction and legal ethics rules. This template is designed as a general reference. For complex legal matters or jurisdictional concerns, consult with a qualified attorney to ensure the engagement letter complies with applicable rules, accurately reflects your agreement, and includes all necessary provisions for your specific situation.
              </p>
            </div>
          </div>
...
export default AttorneyEngagementLetterInfo;
