...
const ITServiceAgreementInfo: React.FC = () => {
  ...
  const doc = documentContent["IT Service Agreement"] || documentContent["default"];
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg p-6 mb-8 flex gap-4">
            ...
            <div>
              ...
              <p className="text-yellow-800 text-sm">
                An IT Service Agreement is an important contract for IT service providers and clients. Requirements and best practices vary by jurisdiction, service type, and business structure. This template is designed as a general reference. For complex IT environments, specialized services, or jurisdiction-specific concerns, consult with a qualified attorney to ensure the agreement complies with applicable laws and includes all necessary provisions for your specific situation.
              </p>
            </div>
          </div>
          ...
          <div className="text-center space-y-4">
            <Button
              onClick={() => navigate("/documents/it-service-agreement")}
              size="lg"
