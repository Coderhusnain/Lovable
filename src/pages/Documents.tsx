...
export const propertyMattersDocs = [
  ...
  { id: "confirmation-phone-call", title: "Confirmation Letter - Telephone Conversation", description: "Confirmation letter following a telephone call regarding identity theft or related matters", icon: FileText, category: "Notices & Letters", component: ConfirmationCallForm },
  ...
  // === PROPERTY PROTECTION ===
  { id: "credit-report-challenge", title: "Credit Report Challenge", description: "Dispute an inaccurate credit report entry and request investigation", icon: Shield, category: "Property Protection", component: CreditReportChallengeForm },
