...
import { CheckCircle, BookOpen, UserCheck, Shield } from "lucide-react";
import { getDocumentContent } from "@/data/documentContent";

const OfferOfEmploymentInfo: React.FC = () => {
  const navigate = useNavigate();
  const doc = getDocumentContent("Offer of Employment");
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center space-y-4">
            <Button
              onClick={() => navigate("/documents/offer-of-employment")}
              size="lg"
...
export default OfferOfEmploymentInfo;
