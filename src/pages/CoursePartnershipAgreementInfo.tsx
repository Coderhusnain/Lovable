import { BookOpen, Users, DollarSign, Shield, CheckCircle, AlertCircle } from "lucide-react";
import { Button } from "@/components/ui/button";
import Layout from "@/components/layout/Layout";
import coursePartnershipAgreementInfo from "@/data/coursePartnershipAgreementInfo";
import { useNavigate } from "react-router-dom";

const CoursePartnershipAgreementInfo: React.FC = () => {
  const navigate = useNavigate();
  const info = coursePartnershipAgreementInfo;
          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
              <div className="flex gap-4 mb-6">
                <AlertCircle className="h-8 w-8 text-teal-600 flex-shrink-0 mt-1" />
                <div>
                  <h2 className="text-3xl font-bold text-gray-900 mb-4">
                    Why You Need a Course Partnership Agreement
                  </h2>
          ...
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {info.keyBenefits.map((benefit, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-teal-600">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {info.howItWorks.ensures.map((item, index) => (
                  <div key={index} className="flex gap-3 p-4 bg-teal-50 rounded-lg">
        ...
        <section className="py-10 bg-gradient-to-r from-teal-600 to-cyan-600">
          <div className="container-custom text-center">
            ...
            <p className="text-lg text-white opacity-90 mb-8 max-w-2xl mx-auto">
              Download a professionally drafted Course Partnership Agreement and protect your course collaboration today.
            </p>
...
export default CoursePartnershipAgreementInfo;
