...
// Remaining forms that need re-conversion
const formsToConvert = [
  'DivorceSettlementAgreementForm.tsx',
  'EmploymentAgreement.tsx',
  'FranchisePurchaseForm.tsx',
  'GeneralPowerOfAttorneyForm.tsx',
  'IndependentContractorForm.tsx',
  'JointVentureAgreementForm.tsx',
  'LLCOperatingAgreementForm.tsx',
  'LoanAgreementForm.tsx',
  'MutualNDAForm.tsx',
  'ParentingPlanForm.tsx',
  'PartnershipAgreementForm.tsx',
  'PrenuptialAgreementForm.tsx',
  'RealEstateContractForm.tsx',
  'RetainerAgreementForm.tsx',
  'RoommateAgreementForm.tsx',
  'SeparationAgreementForm.tsx',
  'ServiceAgreementForm.tsx',
  'SubleaseForm.tsx',
  'lastwill.tsx'
];

function generateGranularForm(fileName) {
  let cleanName = fileName.replace('Form.tsx', '').replace('.tsx', '').replace(/ /g, '');
  
  // Handle special naming
  const nameMap = {
    'DivorceSettlementAgreement': 'DivorceSettlementAgreement',
    'EmploymentAgreement': 'EmploymentAgreement',
    'FranchisePurchase': 'FranchisePurchase',
    'GeneralPowerOfAttorney': 'GeneralPowerOfAttorney',
    ...
    'PrenuptialAgreement': 'PrenuptialAgreement',
    'RealEstateContract': 'RealEstateContract',
    'RetainerAgreement': 'RetainerAgreement',
...
export default function ${cleanName}Form() {
  return (
    <FormWizard
      steps={steps}
      title="${displayTitle}"
