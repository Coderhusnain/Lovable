import{r as m,j as e,W,C as U,k as q,l as V,b as H,a as g,A as Y,d as z,aS as B,J as C}from"./index-Domu0QSH.js";import{I as l}from"./input-CjLHh5sm.js";import{L as t}from"./label-DHWdGN-p.js";import{T as u}from"./textarea-DkKSvL28.js";import{S as J,C as X,a as K}from"./city-B5NRDuuX.js";import{S as p,a as y,b as f,c as _,d as x}from"./select-QzbqEC5l.js";import{E as Q}from"./jspdf.es.min-zKH7-O34.js";import{U as Z}from"./UserInfoStep-CfBu40j_.js";const de=()=>{const[o,c]=m.useState(1),[a,h]=m.useState({agreementDate:"",lessorName:"",lessorAddress:"",lesseeName:"",lesseeAddress:"",county:"",state:"",propertyAddress:"",legalDescription:"",acreage:"",annualRental:"",leaseTerm:"",oilRoyaltyPercentage:"",gasRoyaltyPercentage:"",casingheadGasolinePercentage:"",paymentDay:"",rentalAmount:"",offsetWellDistance:"",mineralTaxPercentage:"",selectedCountry:"",selectedState:"",selectedCity:""}),[N,v]=m.useState(!1),L=5,j=K.getAllCountries(),b=a.selectedCountry?J.getStatesOfCountry(a.selectedCountry):[],E=a.selectedState?X.getCitiesOfState(a.selectedCountry,a.selectedState):[],r=(s,i)=>{h(n=>({...n,[s]:i}))},w=s=>{const i=j.find(n=>n.isoCode===s);h(n=>({...n,selectedCountry:s,selectedState:"",selectedCity:"",state:(i==null?void 0:i.name)||""}))},P=s=>{const i=b.find(n=>n.isoCode===s);h(n=>({...n,selectedState:s,selectedCity:"",county:(i==null?void 0:i.name)||""}))},T=s=>{h(i=>({...i,selectedCity:s}))},S=()=>{v(!0);try{const s=new Q,i=s.internal.pageSize.width,n=20,I=6;let d=n;const A=(O,$=10,k=!1)=>{s.setFontSize($),s.setFont("helvetica",k?"bold":"normal"),s.splitTextToSize(O,i-2*n).forEach(M=>{d>s.internal.pageSize.height-n&&(s.addPage(),d=n),s.text(M,n,d),d+=I})};A("GAS LEASE AGREEMENT",16,!0),d+=5;const G=`This Gas Lease Agreement ("Agreement") is made and entered into on ${a.agreementDate||"[Insert Date]"}, by and between 
