import{r as m,j as e,F as O,C as Y,k as H,l as W,b as B,a as _,A as z,d as V,aQ as q,J as N}from"./index-BAEAUopf.js";import{I as i}from"./input-DnI_Xo94.js";import{L as n}from"./label-BeQ78mSL.js";import{T as c}from"./textarea-BT3hIsff.js";import{S as J,C as U,a as Q}from"./city-B5NRDuuX.js";import{S as u,a as p,b as f,c as x,d as y}from"./select-DKAljqaC.js";import{E as K}from"./jspdf.es.min-CPP5zEfz.js";import{a as X}from"./LegalConcernsSection-stc67HH2.js";import{U as Z}from"./UserInfoStep-D-Ji-2BO.js";import"./alert-DeA80qd9.js";const he=()=>{const[s,h]=m.useState(1),[a,g]=m.useState({agreementDay:"",agreementMonth:"",agreementYear:"",mortgageeName:"",mortgageeAddress:"",tenantName:"",tenantAddress:"",leaseDate:"",landlordName:"",landlordAddress:"",legalDescription:"",propertyAddress:"",mortgageeSignerName:"",mortgageeSignerTitle:"",mortgageeSignatureDate:"",tenantSignerName:"",tenantSignerTitle:"",tenantSignatureDate:"",selectedCountry:"",selectedState:"",selectedCity:""}),[A,j]=m.useState(!1),S=Q.getAllCountries(),C=a.selectedCountry?J.getStatesOfCountry(a.selectedCountry):[],T=a.selectedState?U.getCitiesOfState(a.selectedCountry,a.selectedState):[],r=(t,o)=>{g(l=>({...l,[t]:o}))},D=t=>{g(o=>({...o,selectedCountry:t,selectedState:"",selectedCity:""}))},w=t=>{g(o=>({...o,selectedState:t,selectedCity:""}))},E=t=>{g(o=>({...o,selectedCity:t}))},b=()=>{j(!0);try{const t=new K,o=t.internal.pageSize.width,l=20,I=6;let d=l;const v=(R,$=10,k=!1)=>{t.setFontSize($),t.setFont("helvetica",k?"bold":"normal"),t.splitTextToSize(R,o-2*l).forEach(G=>{d>t.internal.pageSize.height-l&&(t.addPage(),d=l),t.text(G,l,d),d+=I})};v("NON-DISTURBANCE AGREEMENT",14,!0),d+=10;const P=`This Agreement ("Agreement") is made and entered into on the ${a.agreementDay||"___"} day of ${a.agreementMonth||"_______"}, ${a.agreementYear||"20__"}, by and between
