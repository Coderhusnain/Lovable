import{r as E,j as e,C as k,k as _,l as P,b as D,a as S,J as c}from"./index-Bvx_DJOQ.js";import{E as j}from"./jspdf.es.min-D4YI3ioX.js";import{I as s}from"./input-DxWpxYcw.js";import{L as l}from"./label-BgGH2qdj.js";const I=()=>{const[t,n]=E.useState({companyName:"",companyAddress:"",effectiveDate:"",employeeSignature:""}),y=async()=>{try{const o=new j({unit:"pt",format:"letter"}),d=o.internal.pageSize.width,r=40,u=16;let a=r;const i=(g,p=11,w=!1,b=!1)=>{o.setFontSize(p),o.setFont("times",w?"bold":"normal");const v=d-r*2;o.splitTextToSize(g,v).forEach(m=>{if(a>720&&(o.addPage(),a=r),b){const x=o.getStringUnitWidth(m)*p/o.internal.scaleFactor,C=(d-x)/2;o.text(m,C,a)}else o.text(m,r,a);a+=u})};i("EMPLOYEE HANDBOOK",16,!0,!0),a+=10,i(t.companyName||"[Company Name]",12,!0,!0),i(t.companyAddress||"[Company Address]",12,!0,!0),i(`Effective Date: ${t.effectiveDate||"[Insert Date]"}`,12,!0,!0),a+=20;const f=`
