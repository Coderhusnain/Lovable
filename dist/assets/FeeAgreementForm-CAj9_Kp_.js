import{u as E,r as _,j as t,a as u,C as c,b as l,F as R}from"./index-BZJi8bXH.js";import{L as r}from"./label-DWmcNUUx.js";import{I as s}from"./input-CIIwscNp.js";import{T as h}from"./textarea-mJfF61_2.js";import{E as F}from"./jspdf.es.min-Djrbirno.js";function k(){const b=E(),[n,x]=_.useState({effectiveDate:"",recipientName:"",recipientAddress:"",providerName:"",providerAddress:"",servicesDesc:"",totalFee:"",depositAmount:"",depositDate:"",terminationDate:"",noticeDays:"",cureDays:"",jurisdiction:"",arbitration:"",changeOrderProcess:"",signRecipientName:"",signRecipientDate:"",signProviderName:"",signProviderDate:""}),[p,y]=_.useState(1),[j,D]=_.useState(!1),i=a=>{const{name:m,value:o}=a.target;x(f=>({...f,[m]:o}))},A=()=>{const a=new F({unit:"pt",format:"a4"}),m=a.internal.pageSize.getWidth(),o=40,f=m-o*2;let d=o;const e=(N,g=11,w=!1,S=!1)=>{a.setFont("times",w?"bold":"normal"),a.setFontSize(g),a.splitTextToSize(N,f).forEach(v=>{if(d>a.internal.pageSize.getHeight()-o&&(a.addPage(),d=o),S){const C=a.getStringUnitWidth(v)*g/a.internal.scaleFactor,T=(m-C)/2;a.text(v,T,d)}else a.text(v,o,d);d+=g*1.35})};e("FEE AGREEMENT",14,!0,!0),e(`
