import{r as m,j as e,F as O,C as Y,t as B,v as H,c as W,B as _,A as z,l as V,a3 as q,J as N}from"./index-DmiwH21i.js";import{I as i}from"./input-BAgFuN3B.js";import{L as n}from"./label-QTYrxBzu.js";import{T as c}from"./textarea-BBDyVfad.js";import{S as J,C as U,a as K}from"./city-B5NRDuuX.js";import{S as u,a as p,b as f,c as x,d as y}from"./select-CsN3ALin.js";import{E as Q}from"./jspdf.es.min-9HgYH_OZ.js";import{L as X}from"./LegalConcernsSection-X5TYESxF.js";import{U as Z}from"./UserInfoStep-DdXBoRoO.js";import"./index-BdQq_4o_.js";import"./alert-oABTVHDJ.js";import"./phone-Df3-aX1O.js";const me=()=>{const[s,h]=m.useState(1),[a,g]=m.useState({agreementDay:"",agreementMonth:"",agreementYear:"",mortgageeName:"",mortgageeAddress:"",tenantName:"",tenantAddress:"",leaseDate:"",landlordName:"",landlordAddress:"",legalDescription:"",propertyAddress:"",mortgageeSignerName:"",mortgageeSignerTitle:"",mortgageeSignatureDate:"",tenantSignerName:"",tenantSignerTitle:"",tenantSignatureDate:"",selectedCountry:"",selectedState:"",selectedCity:""}),[A,j]=m.useState(!1),S=K.getAllCountries(),C=a.selectedCountry?J.getStatesOfCountry(a.selectedCountry):[],T=a.selectedState?U.getCitiesOfState(a.selectedCountry,a.selectedState):[],r=(t,o)=>{g(l=>({...l,[t]:o}))},D=t=>{g(o=>({...o,selectedCountry:t,selectedState:"",selectedCity:""}))},w=t=>{g(o=>({...o,selectedState:t,selectedCity:""}))},E=t=>{g(o=>({...o,selectedCity:t}))},b=()=>{j(!0);try{const t=new Q,o=t.internal.pageSize.width,l=20,I=6;let d=l;const v=(R,$=10,k=!1)=>{t.setFontSize($),t.setFont("helvetica",k?"bold":"normal"),t.splitTextToSize(R,o-2*l).forEach(G=>{d>t.internal.pageSize.height-l&&(t.addPage(),d=l),t.text(G,l,d),d+=I})};v("NON-DISTURBANCE AGREEMENT",14,!0),d+=10;const P=`This Agreement ("Agreement") is made and entered into on the ${a.agreementDay||"___"} day of ${a.agreementMonth||"_______"}, ${a.agreementYear||"20__"}, by and between
